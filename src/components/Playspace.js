  ...
  // eslint-disable-next-line
    ...
    const handleImageUpload = () => {
      ...
      if (state[0].id===state[2].id) {
        ...
        <input className="f7 grow no-underline br-pill ba ph3 pv2 mb2 dib black" width="80px" id="name" type= "file" aria-describedby="name-desc"/>
        </Row>
  ...
  return (
    ...
    <div className=" " style={{ padding: 10, minHeight: 380 }}>
        <Row gutter={[20, { xs: 8, sm: 24, md: 24, lg: 32 }]}>
           <Profilecard2 state = {state[0]} formerstate={state[1]} loggedinuser={state[2]}/>
        </Row>
